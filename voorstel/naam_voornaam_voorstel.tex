...
\PaperTitle{Wat is de meest performante manier om data te ontvangen en te verzenden: Een vergelijkende studie tussen gRPC en JSON en proof-of-concept }
...
\affiliation{\textbf{Contact:}
  \textsuperscript{1} \href{mailto:sven.pepermans@student.hogent.be}{steven.stevens.u1234@student.hogent.be};
